...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-canvas font-body text-ink">
      ...
      <main className="flex min-h-[calc(100vh-73px)] items-center justify-center p-8">
        <div className="max-w-md rounded-lg border border-hairline bg-surface p-10 text-center">
          <Seal tone="muted" size={40} />
          <h1 className="mt-5 font-display text-xl font-semibold">Painel em construção</h1>
          <p className="mt-2 text-sm text-ink-secondary">
            Em breve: gestão de usuários, acompanhamento de concursos e estatísticas por número.
          </p>
        </div>
      </main>
    </div>
